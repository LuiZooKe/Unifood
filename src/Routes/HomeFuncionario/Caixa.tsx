  ...
  return (
    <Dashboard>
      <div className="p-4 sm:p-6 w-full max-w-[1200px] mx-auto h-[calc(100vh-48px)] flex flex-col">
        ...
        {/* 🔥 Cabeçalho */}
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between bg-[#661111]/90 rounded-2xl shadow-2xl p-4 sm:p-6 border border-[#ffffff22] mb-4 min-h-[12rem] mb:h-[29rem]">
        ...
        {abaAtiva === 'pedidos' ? (
          <>
            {/* 🔥 Botão FILTRAR */}
            <div className="mb-4">
              {/* 🔻 Coloque aqui o componente do botão Filtrar que te enviei */}
              {/* 🔥 Botão Filtrar */}
