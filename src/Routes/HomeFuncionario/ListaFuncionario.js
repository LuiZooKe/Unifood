    ...
    <Dashboard>
      <div className="p-6 text-white overflow-x-hidden w-full">
          ...
          {funcionarios.map((func) => (
            ...
            >
              <div className="flex-1">
                ...
                {/* Campo tipo_usuario removido */}
              </div>
              <div className="flex gap-2 mt-4 md:mt-0">
                <button
                  onClick={() => setModalDetalhes(func)}
        ...
        {modalEditar && editedFuncionario && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 overflow-auto">
            <div className="bg-white text-black p-6 rounded shadow w-full max-w-md mx-4">
              <h3 className="text-3x1 font-bold mb-4">Editar Funcionário</h3>
              <label>Nome</label>
              <input
                type="text"
                value={editedFuncionario.nome}
                onChange={(e) => setEditedFuncionario({ ...editedFuncionario, nome: e.target.value })}
              ...
              <input
                ...
                onChange={(e) => setEditedFuncionario({ ...editedFuncionario, email: e.target.value })}
                className="w-full border px-3 py-2 mb-3"
              />
